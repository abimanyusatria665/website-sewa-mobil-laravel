            ...
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item me-auto">
                    <a class="navbar-brand" href="../../../starter-kit/ltr/vertical-menu-template/"><span
                        ...
                        <h2 class="brand-text">Mobi.co</h2>
                    </a>
                </li>
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="nav-item">
                    <a class="d-flex align-items-center" href="/"><i data-feather="shopping-cart"></i><span
                            class="menu-title text-truncate" data-i18n="Home">Rent</span></a>
                    <ul class="menu-content">
                        <li>
                            <a class="d-flex align-items-center" href="/selling"><i
                                    data-feather="file-text"></i><span class="menu-item text-truncate"
                                    data-i18n="Without Menu">Rent Data</span></a>
                        </li>
                    </ul>
                </li>
                @if (Auth::user()->role == 'admin')
                    <li class="nav-item">
                        <a class="d-flex align-items-center" href="/product"><i data-feather="shopping-bag"></i><span
